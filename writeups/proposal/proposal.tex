...
% FIXME: Use actual tweet figures
\begin{figure}[ht]
  \hfill
  \subfigure[Title A]{\includegraphics[width=8cm]{tweet-screen-crop.pdf}}
  \hfill
  \subfigure[Title B]{\includegraphics[width=8cm]{tweet-screen-crop.pdf}}
  \hfill
...
\subsection{Attentuating Spam Posts}
