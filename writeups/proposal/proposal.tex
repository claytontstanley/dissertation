...
ACT-R's strength of association ($S_{ji}$) and the equivalent pointwise mutual information index ($PMI_{ji}$) have been shown to scale well for large corpora.
...
The SNIF-ACT model uses the strength of association to measure the relationship between the words in a search query and the words contained in each query result.
