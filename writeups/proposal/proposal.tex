...
The current state of research on Twitter hashtag prediction is that a mix of co-occurrence and latent-based models have been used to predict hashtags, and the results are encouraging.
...
The ACT-R declarative memory retrieval model takes a combined approach, and shows how past user behavior and current context combine to produce the most likely retrieval.
