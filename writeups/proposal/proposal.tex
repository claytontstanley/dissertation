...
% FIXME: Use better tweet figures
\begin{figure}[!htbp]
  \hfill
  \subfigure[]{\includegraphics[width=8cm]{twitterTweetExample1.pdf}}
  \hfill
  \subfigure[]{\includegraphics[width=8cm]{twitterTweetExample2.pdf}}
  \hfill
  \caption{Example tweets on Twitter.com}
  \label{figTweetExample}
\end{figure}

FIXME: Write summary paragraph for twitter tweets figures.
...
% FIXME: Use a different example figure
\begin{figure}[!htbp]
  \scalebox{.8}{\resizebox{\linewidth}{!}{\includegraphics{visPost-2977094-screen-crop.pdf}}}
...
\begin{figure}[!htbp]
  \scalebox{.4}{\resizebox{\linewidth}{!}{\includegraphics{google+HashtagExample.pdf}}}
