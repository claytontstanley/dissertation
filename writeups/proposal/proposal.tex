...
It means that we do yet fully understand how well the ACT-R declarative memory theory scales when the number of chunks begins to approach the number of chunks that are actually stored in human declarative memory.
...
There have already been a few researchers that have used these large databases to evaluate how well declarative memory models scale,
