...
Looking at the example post in Figure \ref{figGoogle+Hashtags}, \#BusterPosey is suggested without having that specific word in the post.
Also \textcite{GoogleKeynote2013} mentioned that Google uses its sophisticated image recognition software to suggest hashtags for images that are included in the post (e.g., \#EiffelTower),
