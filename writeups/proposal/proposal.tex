...
I am curious to see the prediction difference between a vector-based models and current co-occurrence models on the StackOverflow dataset.
...
Given that the Bayesian cognitively-plausible models have done so well to predict tag use on StackOverflow, I am curious to see how a cognitively-plausible vector-based model performs at the task.
