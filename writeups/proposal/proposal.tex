...
\abstract{
  ...
  To help organize and structure this information, many users create tags for documents to help connect their content to other posts on similar topics and other users that might have similar interests.
  ...
  Two state-of-the-art memory models will be evaluated: an ACT-R inspired Bayesian model and a random-permutation vector-based model.
