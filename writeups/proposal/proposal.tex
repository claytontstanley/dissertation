...
\title{User-customized hashtag/tag prediction on Twitter and StackOverflow:\protect \\ Comparing vector-based and ACT-R Bayesian models of tag retrieval}
...
\begin{figure}[!htbp]
  \scalebox{.9}{\resizebox{\linewidth}{!}{\includegraphics{superUserTagSuggestion.pdf}}}
...
\textcite{Farahat2004} used $S_{ji}$ values based on a 118GB local database of 10 million pages of the Stanford WebBase Project.
...
The dimensionality of the full word frequency co-occurrence matrix is then forced to be represented on a smaller set of dimensions.
