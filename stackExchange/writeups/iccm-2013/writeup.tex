...
So instead of explicitly removing an enumerated list of stop words, we used a data-driven approach and let the scaled entropy measure attenuate the words that were not predictive of any tag.
...
The result is a table of co-occurrence counts for each of the combinations, which was loaded into R.
