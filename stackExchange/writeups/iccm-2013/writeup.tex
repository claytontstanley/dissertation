...
For example, \citeA{Fu2007} and \citeA{Farahat2004} have shown that ACT-R's retrieval equations are mathematically equivalent to the Pointwise Mutual Information (PMI) index when the sample size of the corpus is large.
\citeA{Budiu2007} and \citeA{Farahat2004} have shown that the PMI index for word co-occurrences is a strong predictor of word similarity and information scent.
And on large corpora \citeA{Budiu2007} has shown that PMI is the best predictor of word pair similarity (compared to LSA and generalized LSA).
...
\begin{figure}[ht]
  \centering
  \resizebox{\linewidth}{!}{\includegraphics{foo.pdf}}
  \caption{
...
\begin{figure}[ht]
  \centering
  \resizebox{\linewidth}{!}{\includegraphics{ROC.pdf}}
  \caption{
