...
For example, note that 'html' is not tagged by the author, but the model ranks it as the second highest tag.
And note that author's tag 'firefox' is only ranked 8th by the model.
